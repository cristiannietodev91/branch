      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: () =>
              import(
                /* webpackChunkName : "profile" */ "./views/app/pages/blog"
              ),
            ...
            children: [
              {
                ...
                component: () =>
                  import(
                    /* webpackChunkName: "profile" */ "./views/app/pages/blog/BlogList"
                  )
              },
              {
                path: "blog-detail",
                component: () =>
                  import(
                    /* webpackChunkName: "profile" */ "./views/app/pages/blog/BlogDetail"
                  )
              }
            ]
          },
