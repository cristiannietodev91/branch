    ...
    <div class="pl-2 d-flex flex-grow-1 min-width-zero">
      ...
      >
        <div class="mb-0 w-30 w-sm-100">
          ...
          >{{ data.usuario && data.usuario.firstName ? data.usuario.firstName : "" }}</p>
        </div>
        <div class="mb-0 w-30 w-sm-100">
        ...
        <div class="mb-0 w-30 w-sm-100">
          ...
          <p class="mb-1 text-small">{{ data.usuario ? data.usuario.celular : "" }}</p>
        </div>
        <div class="mb-0 w-30 w-sm-100 mr-2">
          ...
          <p class="mb-1 text-small">{{ data.usuario ? data.usuario.email : "" }}</p>
        </div>
        <div class="mb-0 w-30 w-sm-100">
