...
<b-row>
    ...
    <b-colxx xxs="12" class="d-none d-md-block">
            ...
            <div class="d-flex flex-grow-1 min-width-zero">
                <b-card-body class="align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                    <p class="list-item-heading mb-0 truncate w-40 w-xs-100">
                        {{$t('pages.prices.twofactorauthentication')}}
                    </p>
        ...
        <b-card no-body class="flex flex-row mb-3">
            <div class="d-flex flex-grow-1 min-width-zero">
                <b-card-body class="align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                    <p class="list-item-heading mb-0 truncate w-40 w-xs-100">
                        {{$t('pages.prices.teampermissions')}}
                    </p>
                    <p class="mb-0 text-primary w-20 w-xs-100 text-center">
                    </p>
                    <p class="mb-0 text-primary w-20 w-xs-100 text-center">
        ...
        <b-card no-body class="flex flex-row mb-3">
            <div class="d-flex flex-grow-1 min-width-zero">
                <b-card-body class="align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                    <p class="list-item-heading mb-0 truncate w-40 w-xs-100">
                        {{$t('pages.prices.useractionsauditlog')}}
                    </p>
                    <p class="mb-0 text-primary w-20 w-xs-100 text-center">
                    </p>
                    <p class="mb-0 text-primary w-20 w-xs-100 text-center">
    ...
    <b-colxx xxs="12" class="d-block d-md-none">
        <b-card no-body class="d-flex flex-row mb-3 table-heading">
            <div class="d-flex flex-grow-1 min-width-zero">
                <b-card-body class="pl-0 pb-0">
                    <p class="list-item-heading mb-0 text-primary">{{$t('pages.prices.twofactorauthentication')}}</p>
                </b-card-body>
            </div>
        </b-card>
        ...
        <b-card no-body class="d-flex flex-row mb-3 table-heading">
            <div class="d-flex flex-grow-1 min-width-zero">
                <b-card-body class="pl-0 pb-0">
                    <p class="list-item-heading mb-0 text-primary">{{$t('pages.prices.useractionsauditlog')}}</p>
                </b-card-body>
            </div>
        </b-card>
        <b-card no-body class="d-flex flex-row mb-3">
